...
<div class="admin-card">
    <div class="admin-card__header">
        ...
        <a href="{{ route('admin.annual-events.edit', $annualEvent) }}" class="admin-btn admin-btn--primary admin-btn--sm">Edit</a>
    </div>
...
<form action="{{ route('admin.annual-events.destroy', $annualEvent) }}" method="POST" onsubmit="return confirm('Delete?')">@csrf @method('DELETE')<button type="submit" class="admin-btn admin-btn--danger">Delete</button></form>
@endsection
